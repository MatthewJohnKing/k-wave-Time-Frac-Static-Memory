...
sensor_data3 = kspaceFirstOrder1D(kgrid, medium, source, sensor, 'PlotSim', false);
%%

% CFLV=[0.64,0.32,0.16,0.08,0.04,0.02,0.01,0.005,0.0025,0.00125,0.000625];
CFLV=[0.64,0.32,0.16,0.08,0.04,0.02,0.01,0.005,0.0025];
...
for CFLLOOP=1:length(CFLV)
    ...
    for loop = 1:3
        ...
        loglog(CFL, err1, string3,'Color',color_map(CFLLOOP,:))
        drawnow
        hold on
