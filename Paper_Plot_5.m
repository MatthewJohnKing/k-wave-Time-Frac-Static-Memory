...
qw{3} = plot(nan, '*','Color',color_map(3,:));
legend([qw{:}], {'\alpha_0=0.5','\alpha_0=0.25','\alpha_0=0.1'}, 'location', 'best')
box on;
title({' ' ;[' ']})
xlabel(ErrPlots,'L')
ylabel(ErrPlots,'Error')
exportgraphics(ErrPlots,'Figure5_a0ErrRef.pdf','BackgroundColor','none','ContentType','vector')