...
% kspaceFirstOrder2DTFis a 2D time-domain simulation of wave
% propagation. Adapted from the kspacefirstorder2D k-wave code.
%
% ADAPTIONS:
    ...
    if ~flags.nonlinear
        switch equation_of_state
            ...
            case 'absorbing'
                ...
                psi=psiupdate(psi,expsdt,onemexp,ovs2,rho0,duxdx,duydy);
...
function psi=psiupdate(psi,expsdt,onemexp,ovs2,rho0,duxdx,duydy)
B=permute(rho0 .* (duxdx + duydy),[3,1,2]);
